...
from orchestrator.execution.command_builders.maven_command_builder import MavenCommandBuilder
from orchestrator.repositories.config_repository import ConfigRepository


class LocalMavenExecutor(BaseExecutor):
    def __init__(self) -> None:
        self.config_repository = ConfigRepository()
        self.command_builder = MavenCommandBuilder()
